	...
	if ( count($content) > 1 ) {
		if ( $more ) {
			...
			if ( ! empty($more_link_text) )
				...
				$output .= apply_filters( 'the_content_more_link', ' <a href="' . get_permalink() . "#more-$id\" class=\"more-link\" title='Leer el resto de \"".get_the_title()."\"'>$more_link_text</a>", $more_link_text );
