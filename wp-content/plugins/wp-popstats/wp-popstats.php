...
Plugin URI: http://www.deltablog.com/popstats/
...
Author: Luis Sancho
Version: 2.2.2
Author URI: http://www.deltablog.com/
*/
...
function ps_parseUserAgent($ua) {
	...
	if (eregi('Win',$ua))
		...
		$array['platform'] = "Macintosh";
	else if (eregi('Linux',$ua))
		$array['platform'] = "Linux";
...
?>
			...
			<table cellpadding="1" cellspacing="0" style="height: 120px;">
			<tr>
...
?>
	...
	<a href="http://www.deltablog.com/popstats/">PopStats <?php echo PS_VERSION; ?></a>
	<br /><a href="http://www.deltablog.com/">Luis Sancho</a>
	</p>
