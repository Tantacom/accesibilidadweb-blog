...
Description: Makes it possible (and trouble free) to post and edit code snippets in wordpress's visual editor. Requires WordPress 2.5 - 2.7. * Adds &lt;pre&gt; &amp; &lt;code&gt; to block format menu. * Allows extra attributes for compatibility in some syntax highlighters (ie, &lt;pre lang="php" line='5'&gt;). * Allows iFrames. * Unescape WP's double escaping of &amp;amp;. * Removes extra  &lt;pre&gt; tags around SyntaxHighllighter Plus's [sourcecode] blocks. * Works in comments.
Version: 1.2.2
