...
<?php if (count ($advanced) > 0) : ?>
	<table width="100%" id="headspace_advanced_<?php echo $id ?>" style="display: none">
	...
	<div style="text-align: right; margin: 0 20px; padding: 0; font-size: 0.9em">
		<a href="#" onclick="jQuery('#headspace_advanced_<?php echo $id ?>').toggle (); return false"><?php _e ('advanced', 'headspace'); ?></a>
	</div>
<?php endif; ?>
